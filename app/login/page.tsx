    ...
    <main className="flex min-h-screen items-center justify-center bg-[#f7f7f8] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-black text-2xl font-bold text-white">
            ◈
          </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-sm text-gray-500">
            {isSignup
              ? "Sign up to start researching your market."
              : "Login to continue to MarketResearch AI."}
          </p>
        ...
        <p className="mt-6 text-center text-xs text-gray-400">
          Your competitive intelligence workspace, powered by AI.
        </p>
      </div>
    </main>
  );
